...
export declare const selectPollByIDBare: import("reselect").OutputParametricSelector<HMSStore<{
    sessionStore: Record<string, any>;
}>, string | undefined, import("@100mslive/hms-video").HMSPoll | null, (res1: Record<string, import("@100mslive/hms-video").HMSPoll>, res2: string | undefined) => import("@100mslive/hms-video").HMSPoll | null>;
/**
