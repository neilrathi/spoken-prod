import { z } from 'zod';
import { createClient as createClient$1, subscriptionExchange } from '@urql/core';
...
var EventTypeSchema = z.nativeEnum(EventType);
function KvSchema() {
  return z.object({
    key: z.string(),
    val: z.string()
...
var OrderDirectionSchema = z.nativeEnum(OrderDirection);
...
var RoleSchema = z.nativeEnum(Role);
...
var StateSchema = z.nativeEnum(State);
...
var StepOrderFieldSchema = z.nativeEnum(StepOrderField);
  ...
  connect() {
    ...
    const wsClient = createClient({
      ...
      on: {
        ...
        opened: (sock) => {
          if (this._firstConnProm && sock.readyState === WebSocket.OPEN) {
...
export { AddGroupInputSchema, AddGroupsDocument, AddParticipantDocument, AddParticipantInputSchema, AddScopeInputSchema, AddScopesDocument, AddStepInputSchema, AddStepsDocument, AttributesDocument, ChangesDocument, EventType, EventTypeSchema, GlobalAttributesDocument, GroupsDocument, KvSchema, LinkDocument, LinkInputSchema, LoginDocument, LoginInputSchema, OnAnyEventDocument, OnAnyEventInputSchema, OnEventDocument, OnEventInputSchema, OrderDirection, OrderDirectionSchema, ParticipantsDocument, RegisterServiceDocument, RegisterServiceInputSchema, Role, RoleSchema, ScopedAttributesDocument, ScopedAttributesInputSchema, ScopesDocument, SetAttributeInputSchema, SetAttributesDocument, State, StateSchema, StepOrderField, StepOrderFieldSchema, StepOrderSchema, StepsDocument, Tajriba, TajribaAdmin, TajribaParticipant, TransitionDocument, TransitionInputSchema, definedNonNullAnySchema, isDefinedNonNullAny };
