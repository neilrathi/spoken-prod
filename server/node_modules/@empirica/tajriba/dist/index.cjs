...
var definedNonNullAnySchema = zod.z.any().refine((v) => isDefinedNonNullAny(v));
function AddGroupInputSchema() {
  return zod.z.object({
    participantIDs: zod.z.array(zod.z.string())
  });
}
function AddParticipantInputSchema() {
  return zod.z.object({
    identifier: zod.z.string()
  });
}
function AddScopeInputSchema() {
  return zod.z.object({
    attributes: zod.z.array(zod.z.lazy(() => SetAttributeInputSchema())).nullish(),
    kind: zod.z.string().nullish(),
    name: zod.z.string().nullish()
  });
}
function AddStepInputSchema() {
  return zod.z.object({
    duration: zod.z.number()
  });
}
var EventTypeSchema = zod.z.nativeEnum(EventType);
function KvSchema() {
  return zod.z.object({
    key: zod.z.string(),
    val: zod.z.string()
...
function LinkInputSchema() {
  return zod.z.object({
    link: zod.z.boolean(),
    nodeIDs: zod.z.array(zod.z.string()),
    participantIDs: zod.z.array(zod.z.string())
  });
}
function LoginInputSchema() {
  return zod.z.object({
    password: zod.z.string(),
    username: zod.z.string()
  });
}
function OnAnyEventInputSchema() {
  return zod.z.object({
    nodeID: zod.z.string().nullish()
  });
}
function OnEventInputSchema() {
  return zod.z.object({
    eventTypes: zod.z.array(EventTypeSchema),
    nodeID: zod.z.string().nullish()
  });
}
var OrderDirectionSchema = zod.z.nativeEnum(OrderDirection);
function RegisterServiceInputSchema() {
  return zod.z.object({
    name: zod.z.string(),
    token: zod.z.string()
  });
}
var RoleSchema = zod.z.nativeEnum(Role);
function ScopedAttributesInputSchema() {
  return zod.z.object({
    ids: zod.z.array(zod.z.string()).nullish(),
    keys: zod.z.array(zod.z.string()).nullish(),
    kinds: zod.z.array(zod.z.string()).nullish(),
    kvs: zod.z.array(KvSchema()).nullish(),
    names: zod.z.array(zod.z.string()).nullish()
  });
}
function SetAttributeInputSchema() {
  return zod.z.object({
    append: zod.z.boolean().nullish(),
    immutable: zod.z.boolean().nullish(),
    index: zod.z.number().nullish(),
    key: zod.z.string(),
    nodeID: zod.z.string().nullish(),
    private: zod.z.boolean().nullish(),
    protected: zod.z.boolean().nullish(),
    val: zod.z.string().nullish()
  });
}
var StateSchema = zod.z.nativeEnum(State);
function StepOrderSchema() {
  return zod.z.object({
    direction: OrderDirectionSchema,
    field: StepOrderFieldSchema.nullish()
  });
}
var StepOrderFieldSchema = zod.z.nativeEnum(StepOrderField);
function TransitionInputSchema() {
  return zod.z.object({
    cause: zod.z.string().nullish(),
    from: StateSchema,
    nodeID: zod.z.string(),
    to: StateSchema
  });
...
var Tajriba = class extends events_default {
  ...
  connect() {
    ...
    const wsClient = graphqlWs.createClient({
      ...
      lazy: false,
      shouldRetry: () => true,
      webSocketImpl: WebSocket__default["default"],
      on: {
        connecting: () => {
        },
        connected: () => {
        ...
        opened: (sock) => {
          if (this._firstConnProm && sock.readyState === WebSocket__default["default"].OPEN) {
    ...
    this._client = core.createClient({
      url: this.url,
      exchanges: [
        core.subscriptionExchange({
  ...
  async setAttributes(input) {
    return await this.mutate(
      ...
      { input },
      (data) => data == null ? void 0 : data.setAttributes.map((p) => p.attribute)
    );
  }
...
var TajribaAdmin = class extends Tajriba {
  async addSteps(input) {
    return await this.mutate(
      AddStepsDocument,
      { input },
      (data) => data == null ? void 0 : data.addSteps.map((p) => p.step)
    );
  }
  async addStep(input) {
  ...
  async addGroups(input) {
    return await this.mutate(
      AddGroupsDocument,
      { input },
      (data) => data == null ? void 0 : data.addGroups.map((p) => p.group)
    );
  }
  ...
  async addScopes(input) {
    return await this.mutate(
      AddScopesDocument,
      { input },
      (data) => data == null ? void 0 : data.addScopes.map((p) => p.scope)
    );
  }
...
exports.AddGroupInputSchema = AddGroupInputSchema;
exports.AddGroupsDocument = AddGroupsDocument;
exports.AddParticipantDocument = AddParticipantDocument;
exports.AddParticipantInputSchema = AddParticipantInputSchema;
exports.AddScopeInputSchema = AddScopeInputSchema;
exports.AddScopesDocument = AddScopesDocument;
exports.AddStepInputSchema = AddStepInputSchema;
exports.AddStepsDocument = AddStepsDocument;
exports.AttributesDocument = AttributesDocument;
exports.ChangesDocument = ChangesDocument;
exports.EventType = EventType;
exports.EventTypeSchema = EventTypeSchema;
exports.GlobalAttributesDocument = GlobalAttributesDocument;
exports.GroupsDocument = GroupsDocument;
exports.KvSchema = KvSchema;
exports.LinkDocument = LinkDocument;
exports.LinkInputSchema = LinkInputSchema;
exports.LoginDocument = LoginDocument;
exports.LoginInputSchema = LoginInputSchema;
exports.OnAnyEventDocument = OnAnyEventDocument;
exports.OnAnyEventInputSchema = OnAnyEventInputSchema;
exports.OnEventDocument = OnEventDocument;
exports.OnEventInputSchema = OnEventInputSchema;
exports.OrderDirection = OrderDirection;
exports.OrderDirectionSchema = OrderDirectionSchema;
exports.ParticipantsDocument = ParticipantsDocument;
exports.RegisterServiceDocument = RegisterServiceDocument;
exports.RegisterServiceInputSchema = RegisterServiceInputSchema;
exports.Role = Role;
exports.RoleSchema = RoleSchema;
exports.ScopedAttributesDocument = ScopedAttributesDocument;
exports.ScopedAttributesInputSchema = ScopedAttributesInputSchema;
exports.ScopesDocument = ScopesDocument;
exports.SetAttributeInputSchema = SetAttributeInputSchema;
exports.SetAttributesDocument = SetAttributesDocument;
exports.State = State;
exports.StateSchema = StateSchema;
exports.StepOrderField = StepOrderField;
exports.StepOrderFieldSchema = StepOrderFieldSchema;
exports.StepOrderSchema = StepOrderSchema;
exports.StepsDocument = StepsDocument;
exports.Tajriba = Tajriba;
exports.TajribaAdmin = TajribaAdmin;
exports.TajribaParticipant = TajribaParticipant;
exports.TransitionDocument = TransitionDocument;
exports.TransitionInputSchema = TransitionInputSchema;
exports.definedNonNullAnySchema = definedNonNullAnySchema;
